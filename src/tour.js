const tour = [
  ...
  { title:
     'STOP #2 Ratzer Map (Confidential): A Young Colonel in New York (1756)',
    slide:
  ...
  { title:
    'STOP #3 Washington’s Headquarters Flag (Flag Gallery): Revolutionary Beginnings (1773 - 1775)',
    slide:
  ...
  { title:
    'STOP #4 The Pulling Down of the King George III Statue (Fear and Force): Independence (1776)',
    slide:
  ...
  { title:
    'STOP #4 The Pulling Down of the King George III Statue (Fear and Force): Independence (1776)',
    slide:
    '4. (HANDOUT: British fleet anchored off Staten Island) On June 25th, 1776 (a day after Hickey’s execution) patriot lookouts witnessed the long-awaited British fleet sailing into New York Harbor. Within a 24-hour period, nine-thousand or so redcoats began to set about fortifying Staten Island. As tensions ran high among both sides, Washington urged his men to be ready at a moments notice. Shortly after the British appeared on NY shores, the Continental Congress in Philadelphia voted in favor of independence on July 2nd and adopted the Declaration of Independence, two days later on July 4th. The NY Provincial Congress approved of the document on July 9th and later that same day, under Washington’s general orders: “The several brigades are to be drawn up this evening on their respective Parades, at six OClock, when the declaration of Congress, shewing the grounds & reasonsof this measure, is to be read with an audible voice.” The Declaration was read to Washington’s troops at the city commons (modern-day City Hall park), soldiers and civilians rallied behind Independence- to the point in which a mob developed.' },
  { title:
    'STOP #4 The Pulling Down of the King George III Statue (Fear and Force): Independence (1776)',
    slide:
  ...
  { title:
    'STOP #4 The Pulling Down of the King George III Statue (Fear and Force): Independence (1776)',
    slide:
    'Transition:  Three days later on July 12th, 1776, General Washington watched as two British warships detached themselvesfrom the main English fleet off the shore of Staten Island. New Yorkers and American soldiers alike, witnessed the ships sail into New York Harbor and the Hudson River. The warships opened their gun ports and began blasting the Western shoreline of Manhattan. In a practice maneuver meant to test American fortifications, Washington’s plan for the city’s defense utterly failed, foreshadowing what was to come...' },
  { title:
    'STOP #5: Brown Bess (Fear and Force): The Battle for New York (Summer of 1776)',
    slide:
  ...
  { title:
    'STOP #5: Brown Bess (Fear and Force): The Battle for New York (Summer of 1776)',
    slide:
       'Transition: Four days later the British landed at Kips Bay (East 34th St), which resulted in a push by General Putnam tomarch American Troops upwards to Harlem Height. On September 16th, Washington headquartered at the Morris-Jumel Mansion, engaged in the Battle of Harlem Heights; his last push to defend New York (An American victory, and Washington’s first battlefield victory of the war). Additionally, Congress made the decision that New York should not be burned to the ground, yet on the nightof September 21st lower Manhattan was engulfed in flames from Broad Street to the Western Shoreline (the causes of which are unknown). In which Washington wrote: “Providence, or some good honest fellow has done more for us than we were willing to do forourselves.” Following defeats at both White Plans and Fort Washington, General Washington finally left New York City proper for good, not to return until 1783.' },
  { title:
    'STOP #6: [Half-Stop] Sons of the Revolution: Collection Case: The Hudson Highlands  (1776 - 1779?)',
    slide:
  ...
  { title:
    'STOP #6: [Half-Stop] Sons of the Revolution: Collection Case: The Hudson Highlands  (1776 - 1779?)',
    slide:
    '1. Following his defeat in New York, Washington would always be within a few days march from the city. Washington soughtto maintain control of the Hudson River Highlands, controlling navigation between on both the Hudson River and the major Post Roads, between New York and Albany, and eventually onto the rest of the New England states.  As New York City remained under British control until the close of the war in 1783, the American General wanted to contain English influence.' },
  { title:
    'STOP #6: [Half-Stop] Sons of the Revolution: Collection Case: The Hudson Highlands  (1776 - 1779?)',
    slide:
  ...
  { title:
    'STOP #7: The Tallmadge Memoirs: British NYC and the Spymaster (1778-1783)',
    slide:
  ...
  { title:
    'STOP #7: The Tallmadge Memoirs: British NYC and the Spymaster (1778-1783)',
    slide:
    '4.2 A system of three digit numbers served as words or phases was devised to encrypt the ring’s information, in case theintel would fall into the wrong hands (ex: Washington:711, New York: 727, Long Island: 728, Tallmadge: 721, more codes provided in the link below).' },
  { title:
    'STOP #7: The Tallmadge Memoirs: British NYC and the Spymaster (1778-1783)',
    slide:
  ...
  { title:
    'STOP #7: The Tallmadge Memoirs: British NYC and the Spymaster (1778-1783)',
    slide:
    'Transition: Only a fraction of the intelligence work done during the war; the actions of the Culper Spy Ring helped to ultimately defeat the British in 1781. In 1780, the ring uncovered a planned English attack on French troops en route to aid theAmericans. With advance warning, Washington prepared a defense and the British withdrew from their plans. Moreover, the ring worked to capture Major John Andre, who was known for his collusion with the infamous turncoat Benedict Arnold. Washington and Tallmadge’s work within the New York Spy Ring laid the groundwork for today’s intelligence community and without said work the outcome of the American Revolution might have been drastically different. The Culper Spy Ring’s activity ended in 1783, as the British withdrew from NYC and Washington in his victorious return, stepped onto the shores of Manhattan for the first time sevenyears…' },
  { title:
    'STOP #8: The Long Room: End of War and Farewell Speech (1781-1783)',
    slide:
  ...
  { title:
    'STOP #8: The Long Room: End of War and Farewell Speech (1781-1783)',
    slide:
    '1. Aided by French Land and Naval forces, the Contenital Army under the command of Gen. Washington laid siege to Englishtroops, in what became known as the Battle of Yorktown. On October 19th, 1781 a white flag emerged from the English encampmentand Lord Cornwallis offer his terms of surrender to Gen. Washington. Cornwallis’ defeat at Yorktown, set in motion a series ofnegotiations that led to the signing of the Treaty of Paris in 1783 (completely different document from the earlier ‘63 treaty).' },
  { title:
    'STOP #8: The Long Room: End of War and Farewell Speech (1781-1783)',
    slide:
